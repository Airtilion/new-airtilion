...
const page = async ({ searchParams }) => {
    ...
    const file = await getDictionary(lang, 'offer-shops');
    ...
    const schema = getPageSchema({
        title: 'Innowacyjne rozwiązania dla sklepów internetowych',
        description: 'Sprawdź nasze usługi tworzenia sklepów internetowych i zwiększ swoją sprzedaż online! Tworzymy sklepy w oparciu o WooCommerce i nie tylko.',
        slug: 'https://airtilion.com/oferta-sklepy-internetowe',
    })
