  ...
  return (
    <div className='flex gap-3 relative w-fit max-sm:gap-2 max-sm:flex-wrap max-sm:justify-center max-sm:w-[200px] max-sm:gap-y-8'>
        {socials.map((social, idx) => (
            <Link key={idx} href={social.link} target='_blank' className='w-[40px] h-[40px] border-[0.5px] border-[#afafaf] rounded-full flex justify-center items-center bg-[#000000] group duration-500 hover:border-[#E28350] max-sm:w-[35px] max-sm:h-[35px]'>
