  ...
  return (
    <header className='mt-40 relative flex-center gap-16 section-style max-xl:gap-24 max-lg:flex-col max-lg:gap-16'>
      ...
      <div className='w-[590px] max-2xl:w-[560px] max-xl:w-[364px] max-lg:w-[425px] max-sm:w-[90%]'>
        <Image src={portfolio} alt='Kolaż makiet z naszymi realizacjami - nowoczesne strony internetowe Nowy Sącz dla branży budowlanej i handlowej' width={591} height={717} className='object-cover aspect-[591/717] opacity-animation' />
      </div>
