...
const PortfolioTile = ({ index, title, desc, bg, id, clientId }) => {
    ...
    return (
        <Link href={`/portfolio/${id}`} className='w-[298px] h-[400px] animation-left transition-all duration-1000 ease-in-out group'>
            <div className={`w-[298px] h-[400px] flex flex-col gap-2 p-8 justify-end rounded-[5px] ${marginTop} max-2xl:w-[283px] max-xl:w-[234px] max-xl:h-[350px] max-xl:p-4 max-lg:w-[300px] animation-left transition-all duration-1000 ease-in-out overflow-hidden`} style={{ transitionDelay: index * 100 + 'ms' }}>
