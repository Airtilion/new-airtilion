...
const SinglePost = ({ category, title, intro, image, slug, index }) => {
    return (
        <Link href={`/blog/${slug}`} className='animation-left transition-all duration-1000 ease-in-out' style={{transitionDelay: index*100+'ms'}}>
            <div className='h-[438px] w-[468px] flex flex-col p-[32px] relative justify-between rounded-[5px] overflow-hidden group max-2xl:w-[400px] max-2xl:h-[400px] max-xl:w-[550px] max-xl:h-[320px] max-lg:w-[330px] max-lg:h-[330px] fold:w-[290px]'>
