...
const SlideUpContact = ({ dict, lang }) => {
  const [isContactOpen, setIsContactOpen] = useState(false)
  const [isVisible, setIsVisible] = useState(false)

  useEffect(() => {
    const openHandler = () => setIsContactOpen(true)
    window.addEventListener('openContact', openHandler)
    return () => window.removeEventListener('openContact', openHandler)
  }, [])
