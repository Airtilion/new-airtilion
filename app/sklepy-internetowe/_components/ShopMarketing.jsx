...
const ShopMarketing = ({ dict }) => {
    return (
        <section className='mt-32 relative'>
            <div className='section-style grid grid-cols-2 gap-24 max-lg:grid-cols-1'>

                <div className='relative rounded-2xl overflow-hidden aspect-[4/5] max-lg:w-[480px] max-lg:mx-auto max-sm:w-auto max-sm:mx-0'>
                    <Image src={marketing} alt="" fill className='object-cover' sizes="(max-width: 1024px) 100vw, 50vw" />
