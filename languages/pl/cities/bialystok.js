...
export const bialystok = {
    ...
    header: {
        ...
        content: [
            "Tworzymy nowoczesne i eleganckie strony internetowe dopasowane do potrzeb klientów z regionu, łącząc funkcjonalność z estetyką. Oferujemy projektowanie i tworzenie stron internetowych od zera, korzystając z intuicyjnego systemu CMS lub dedykowanych rozwiązań.",
            "Każda strona www Białystok jest w pełni responsywna, szybka i bezpieczna. Obsługujemy klientów z regionu oraz z całej Polski - nie mamy ograniczeń geograficznych. Skontaktuj się z nami, a omówimy szczegóły współpracy, opowiemy o procesie tworzenia strony i przedstawimy darmową wycenę!"
        ],
        button: [
            "Wycenimy twój projekt w 24h - przeprowadzimy Cię przez cały proces",
            "Kliknij aby odebrać darmową wycenę"
        ]
    },

    introduction: {
        tag: "Z nami zyskujesz więcej niż tylko obecność w sieci",
        title: "Profesjonalne strony i sklepy internetowe Białystok",
        ...
        ending: "Projektowanie stron internetowych Białystok - nowoczesność i jakość w jednym miejscu",
        alts: [
            "Pierwsza część laptopa przedstawiającego stronę internetową w Białymstoku",
            "Druga część laptopa przedstawiającego stronę internetową w Białymstoku"
        ]
    },

    advantages: {
        title: "Dlaczego warto zainwestować w stronę internetową dla firmy w Białymstoku?",
        elements: [
            {
            ...
            {
                title: `Zbudujesz zaufanie i wiarygodność Twojej firmy w Białymstoku`,
        ...
        alt: "Telefon prezentujący sklep internetowy z Białegostoku"
    },
    ...
    technology: {
        ...
        content: [
            "Tworzymy funkcjonalne, estetyczne i w pełni responsywne witryny oparte na nowoczesnych technologiach, które gwarantują niezawodność, szybkość działania i bezproblemowe funkcjonowanie strony w każdych warunkach. Nasze projekty stron powstają z myślą o indywidualnych potrzebach klienta - Twoja witryna będzie nie tylko atrakcyjna wizualnie, ale przede wszystkim intuicyjna w obsłudze.",
            "Wykorzystujemy rozwiązania przyspieszające ładowanie (minifikacja kodu, kompresja obrazów), dbamy o optymalizację SEO oraz w razie potrzeby implementujemy system CMS, dzięki któremu będziesz mógł/mogła samodzielnie edytować swoją stronę www. Dzięki temu wszystko działa płynnie na komputerach i urządzeniach mobilnych, a regularne aktualizacje i backupy chronią dane osobowe użytkowników."
        ],
        elements: [
        ...
        alt: "Dwa telefony z mobilną wersją strony stworzonej w Białymstoku"
    },
    ...
    production: {
        ...
        alt: "Ciemne tło pomieszczenia - aplikacje internetowe Białystok"
    },

    offer: {
        title: "Nasza oferta strony www dla firm z Białegostoku",
        content: "Tworzymy nowoczesne, szybkie i przyjazne SEO strony internetowe, które przyciągną klientów z Białegostoku i okolic. Specjalizujemy się w:",
        tiles: [
            {
        ...
        alts: [
            "Tło projektu strony internetowej w Białymstoku",
            "Ikona strony wizytówki",
            "Ikona Strony firmowej",
            "Ikona sklepu internetowego"
        ],
    ...
    portfolio: {
        ...
        content: [
            "Zobacz wybrane realizacje i przekonaj się, jak możemy pomóc rozwinąć Twoją działalność online.",
            "Masz pomysł na stronę internetową w Białymstoku?"
        ],
        button: "Przejdź do portfolio",
        alts: [
            'Wizualizacja pierwszej przykładowej strony internetowej Białystok',
            'Wizualizacja drugiej przykładowej strony internetowej Białystok'
        ]
    },
    ...
    faq: {
        ...
        elements: [
            ...
            {
                id: 2,
                q: "Ile kosztuje strona w Białymstoku?",
