...
export const slupsk = {
    ...
    introduction: {
        ...
        title: "Profesjonalne strony i sklepy internetowe Słupsk",
        ...
        ending: "Projektowanie stron internetowych Słupsk - nowoczesność i jakość w jednym miejscu",
        alts: ["Pierwsza część laptopa przedstawiającego stronę internetową w Słupsku", "Druga część laptopa przedstawiającego stronę internetową w Słupsku"]
    },

    advantages: {
        title: "Dlaczego warto zainwestować w stronę internetową dla firmy w Słupsku?",
        elements: [
            {
            ...
            {
                title: `Zbudujesz zaufanie i wiarygodność Twojej firmy ze Słupska`,
            ...
            },
            {
                ...
                desc: `Zwiększ zasięg swojego biznesu i przyciągnij nowych klientów ze Słupska.`
            }
        ],
        alt: "Telefon prezentujący sklep internetowy ze Słupska"
    },
    ...
    technology: {
        ...
        alt: "Dwa telefony z mobilną wersją strony stworzonej w Słupsku"
    },
    ...
    production: {
        ...
        alt: "Ciemne tło pomieszczenia - aplikacje internetowe Słupsk"
    },

    offer: {
        title: "Nasza oferta strony www dla firm ze Słupska",
        content: "Tworzymy nowoczesne, szybkie i przyjazne SEO strony internetowe, które przyciągną klientów ze Słupska i okolic. Specjalizujemy się w:",
        tiles: [
            {
        ...
        alts: ["Tło projektu strony internetowej w Słupsku", "Ikona strony wizytówki", "Ikona Strony firmowej", "Ikona sklepu internetowego"],
        button: "Przejdź do darmowej wyceny",
    },

    portfolio: {
        title: "Chcesz zapoznać się z naszymi realizacjami?",
        content: ["Zobacz wybrane realizacje i przekonaj się, jak możemy pomóc rozwinąć Twoją działalność online.", "Masz pomysł na stronę internetową w Słupsku?"],
        button: "Przejdź do portfolio",
        alts: ['Wizualizacja pierwszej przykładowej strony internetowej Słupsk', 'Wizualizacja drugiej przykładowej strony internetowej Słupsk']
    },
    ...
    faq: {
        ...
        elements: [
            ...
            {
                id: 2,
                q: "Ile kosztuje strona w Słupsku?",
