...
const PortfolioGrid = async ({ dict }) => {
            ...
            <div className='section-style'>
                ...
                <div className='mt-16 grid grid-cols-2 gap-8 max-md:grid-cols-1'>
                    {fetchedProjects.map((project) => (
                        <Link href={`https://airtilion.com/portfolio/${project.id}`} key={project.id} className='group flex flex-col gap-6'>
                            ...
                            <div className='flex flex-col flex-grow justify-between max-sm:text-center max-sm:items-center'>
                                <h3 className='text-[24px] text-white max-lg:text-[22px] max-sm:text-[20px]'>{project.Name}</h3>
