    ...
    return (
        <section className='blog-intro mt-[64px] w-[1240px] mx-auto flex gap-[32px] max-xl:w-[1000px] max-lg:w-[90%] max-lg:flex-col max-lg:items-center'>
            ...
            <div className='flex-1 relative h-full'>
                ...
                <div className='rounded-[5px] bg-[linear-gradient(202deg,#E2B35000_60%,#E2B350ff_140%)] brightness-50 absolute top-0 left-0 w-[600px] h-full max-xl:w-[484px] max-lg:w-full' />
            </div>
