    ...
    return (
        <section id='technical-seo' className='mt-48 relative overflow-hidden py-48 technical-seo-hidden'>
            ...
            <div className='section-style-small text-paragraph text-center'>
                <h2 className='mt-8 text-[30px] heading-gradient-gray animation-bottom transition-all duration-1000 ease-in-out max-2xl:text-[25px] max-sm:text-[20px]'>{dict.title}</h2>
                <p className='mt-4 animation-bottom transition-all duration-1000 ease-in-out' dangerouslySetInnerHTML={{ __html: dict.desc[0] }} />
                <p className='mt-4 animation-bottom transition-all duration-1000 ease-in-out' dangerouslySetInnerHTML={{ __html: dict.desc[1] }} />

                <div className='mt-16'>
                    <p className='text-[20px] animation-bottom transition-all duration-1000 ease-in-out max-xl:text-[18px] max-sm:text-[16px]'>{dict.subtitle}</p>
